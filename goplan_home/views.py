...
def place_detail(request):
    """
    Return a dataset place so the frontend
    can promote a clicked card.
    """
    ...
    recommendations = [
        candidate
        for candidate in recommend_places(
            place["name"],
            top_k=6
        )
...
def weather(request):
    """
    Proxy current Open-Meteo weather without exposing
